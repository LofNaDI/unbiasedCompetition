function [spikeevents,spiketimes,dynrate] = getPoissonDutyCycleSpikeTimes(tOn,tOff,latency_,freq_,normFreqSigma_,phase_,widthSigma,baseline,dc_,ac_,slopeDutyCycle_,thresholdDutyCycle_,T,N)
